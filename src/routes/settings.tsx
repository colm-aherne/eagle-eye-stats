          ...
          <div className="mt-3 flex flex-col gap-2 sm:flex-row">
            <div className="flex-1">
              <CourseSearchInput
                ...
                placeholder="Search courses… e.g. Royal Portrush"
              />
            </div>
            <div className="flex gap-2">
              <Button
                ...
                onClick={() => {
                  ...
                  const s = pickedSuggestion && pickedSuggestion.name === n ? pickedSuggestion : undefined;
                  setHomeCourse({ name: n, suggestion: s });
